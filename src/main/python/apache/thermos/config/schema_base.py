...
class Task(Struct):
  ...
  quit_escalation_wait = Default(Integer, 5)   # The amount of time in seconds to wait after running
                                               # the /quitquitquit handler.

  abort_escalation_wait = Default(Integer, 5)  # The amount of time in seconds to wait after running
                                               # the /abortabortabort handler.
